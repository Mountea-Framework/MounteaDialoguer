	...
	createOnboardingExampleProject: async () => {
		...
		try {
			...
			const hardcodedNodePositions = {
				'00000000-0000-0000-0000-000000000001': { x: 250, y: 100 },
				'10000000-0000-4000-8000-000000000001': { x: 195.5, y: 288 },
				'10000000-0000-4000-8000-000000000002': { x: -1682.75, y: 549 },
				'10000000-0000-4000-8000-000000000003': { x: -584.25, y: 549 },
				'10000000-0000-4000-8000-000000000004': { x: 225, y: 549 },
				'10000000-0000-4000-8000-000000000005': { x: 869.5, y: 549 },
				'10000000-0000-4000-8000-000000000006': { x: 1252, y: 549 },
				'20000000-0000-4000-8000-000000000001': { x: -1724.25, y: 773 },
				'20000000-0000-4000-8000-000000000002': { x: -1669.25, y: 1050 },
				'20000000-0000-4000-8000-000000000003': { x: -1740.75, y: 1258 },
				'20000000-0000-4000-8000-000000000004': { x: -1961.75, y: 1537.5 },
				'20000000-0000-4000-8000-000000000005': { x: -1612.25, y: 1537.5 },
				'20000000-0000-4000-8000-000000000006': { x: -1285.25, y: 1537.5 },
				'20000000-0000-4000-8000-000000000007': { x: -1969.25, y: 1798.5 },
				'20000000-0000-4000-8000-000000000008': { x: -1654.25, y: 1780 },
				'20000000-0000-4000-8000-000000000009': { x: -1270.25, y: 1790.5 },
				'30000000-0000-4000-8000-000000000001': { x: -653.25, y: 773 },
				'30000000-0000-4000-8000-000000000002': { x: -1001.75, y: 1034 },
				'30000000-0000-4000-8000-000000000003': { x: -584.25, y: 1034 },
				'30000000-0000-4000-8000-000000000004': { x: -236.25, y: 1034 },
				'30000000-0000-4000-8000-000000000005': { x: -1053.25, y: 1276.5 },
				'30000000-0000-4000-8000-000000000006': { x: -647.25, y: 1276.5 },
				'30000000-0000-4000-8000-000000000007': { x: -221.25, y: 1268.5 },
				'30000000-0000-4000-8000-000000000008': { x: -985.25, y: 1529.5 },
				'30000000-0000-4000-8000-000000000009': { x: -569.25, y: 1529.5 },
				'40000000-0000-4000-8000-000000000001': { x: 169, y: 791.5 },
				'40000000-0000-4000-8000-000000000002': { x: 235, y: 1050 },
				'40000000-0000-4000-8000-000000000003': { x: 51.25, y: 1276.5 },
				'40000000-0000-4000-8000-000000000004': { x: 398.75, y: 1276.5 },
				'40000000-0000-4000-8000-000000000005': { x: -11.25, y: 1519 },
				'40000000-0000-4000-8000-000000000006': { x: 413.75, y: 1529.5 },
				'50000000-0000-4000-8000-000000000001': { x: 831, y: 773 },
				'50000000-0000-4000-8000-000000000002': { x: 701.25, y: 1034 },
				'50000000-0000-4000-8000-000000000003': { x: 1001.25, y: 1034 },
				'50000000-0000-4000-8000-000000000004': { x: 698.75, y: 1276.5 },
				'50000000-0000-4000-8000-000000000005': { x: 1047.75, y: 1292.5 },
				'50000000-0000-4000-8000-000000000006': { x: 987.75, y: 1537.5 },
				'60000000-0000-4000-8000-000000000001': { x: 1208, y: 773 },
			};
			const positionedNodes = nodes.map((node) => ({
				...node,
				position: hardcodedNodePositions[node.id] || node.position,
			}));
